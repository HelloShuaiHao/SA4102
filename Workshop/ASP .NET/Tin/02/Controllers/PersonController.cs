...
namespace Routing_Workshop.Controllers
{
    public class PersonController : Controller
    {
         ...
         * 
         * https://localhost:7004/Person/CreatePerson/John/45
         */
         ...
         * 
         * 
         * https://localhost:7004/Person/CompareTwoPerson/?p1.Name=Clark%20Kent&p1.Age=62&p2.Name=Bruce%20Wayne&p2.Age=61
         */
        public IActionResult CompareTwoPerson(Person p1, Person p2)
        {
            ...
            {
                return Content(string.Format("{0} is older than {1}", p2, p1));
            }
        }
