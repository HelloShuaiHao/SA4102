...
namespace OOPCS_Workshop_Inheritance_PartII
{
   class Test
   {
      ...
      {
            BankBranch newBank = new BankBranch("ICBC");
         ...
         Console.WriteLine(savingAccount.ToString());
         bool canWithraw = savingAccount.Withdraw(3000);
         if (canWithraw)
         {
         ...
         else
         {
            ...
            newBank.AddAccount(savingAccount);
         ...
         // Console.WriteLine();
            ...
            newBank.AddAccount(currentAccount);
            ...
            newBank.AddAccount(overdraftAccount1);
            newBank.AddAccount(overdraftAccount2);



            newBank.PrintAccounts();
            newBank.PrintCustomers();
            Console.WriteLine(newBank.TotalDeposit());
            Console.WriteLine(newBank.TotalInterestPaid());
            Console.WriteLine(newBank.TotalDeposit());
